		...
		<div style="max-width:1800px; margin:auto;">
			<div  id="divLogin" style="display:none; margin:auto;">
				...
				<table align="center">
					...
					<tr><td><input id="btnAccesoAdm" style="width:150px; border:1px #666666 solid;" name="btnAccesoAdm" type="button" value="Módulo Administrador" onclick="location.href='/index.php';" /></td></tr> 
				...
				<div class="barraIzq">
					<table width="100%">
						<tr><td height="300px;" align="center">
								<div style="background-image:url(imagenes/imagenrarilat.png); background-size:contain; height:100%; width:70%; background-repeat:no-repeat;"></div>
						</td></tr>
